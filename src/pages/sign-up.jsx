...
import { CircleUser, Eye, EyeOff, FileSearch, LockKeyhole, Mail } from 'lucide-react';
...
const Signup = () => {
    ...
    return (
        <main className='h-screen w-full flex items-end justify-around'>
            ...
            <Form {...form}>
                { loading && <Loader />}
                    <form onSubmit={form.handleSubmit(onSignup)} className='border mb-24 w-[400px] p-10 rounded-lg shadow-md'>
